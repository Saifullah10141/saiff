...
<head>
    ...
    <title>Course Coordinator ID Created</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="content">
        ...
        <div class="message-container">
            Course Coordinator ID has been created Successfully!
        </div>
        <a href="create_course_coordinator.php" class="back-button">Create Another Course Coordinator ID</a>
