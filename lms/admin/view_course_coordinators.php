...
<head>
    ...
    <title>View and Manage Course Coordinators</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="content">
        ...
        <input type="text" id="searchInput" placeholder="Search Course Coordinators...">
...
<script>
    ...
    function loadCoordinators() {
        fetch('get_course_coordinators.php')
            .then(res => res.json())
            .then(data => {
                    ...
                    tbody.innerHTML += `
                        <tr>
                            ...
                            <td>
                                ...
                                <button onclick="deleteCoordinator('${row.coordinator_id}')">Delete</button>
                            </td>
                        </tr>`;
                });
            })
    ...
    document.getElementById("editForm").addEventListener("submit", function (e) {
        ...
        fetch("update_course_coordinator.php", {
            method: "POST",
            body: formData
        })
            .then(res => res.text())
    ...
    function deleteCoordinator(id) {
        if (confirm("Are you sure you want to delete this course coordinator?")) {
            fetch('delete_course_coordinator.php', {
                method: 'POST',
