...
<head>
    ...
    <title>Create LMS Manager ID</title>
    <style>
         * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="content">
        ...
        <div class="form-container">
            <h2>Create LMS Manager ID</h2>
            <form action="create_lms_manager0.php" method="post">
                <label>Reg. No.</label>
                ...
                <button type="submit">Create LMS Manager ID</button>
            </form>
        </div>
    </div>
    <script>
