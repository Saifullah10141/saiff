...
<head>
    ...
    <title>View and Manage Instructor</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<script>
                    ...
                    tbody.innerHTML += `
                        <tr>
                            ...
                            <td>
                                ...
                                <button onclick="deleteCoordinator('${row.instructor_id}')">Delete</button>
                            </td>
                        </tr>`;
                });
            })
    ...
    document.getElementById("editRank").value = row[9].textContent;
    // Set up the modal
