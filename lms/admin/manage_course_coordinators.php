...
<head>
    ...
    <title>Manage Course Coordinators</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="content">
        ...
        <div class="options-container">
            <div class="option-card">
                <a href="create_course_coordinator.php">Create New Course Coordinator ID</a>
            </div>
            <div class="option-card">
                <a href="view_course_coordinators.php">View & Manage Course Coordinators</a>
            </div>
        </div>
    </div>
</body>
