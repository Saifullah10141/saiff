...
<head>
    ...
    <title>Instructor ID Created</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="content">
        ...
        <div class="message-container">
            Instructor ID has been created Successfully!
        </div>
        <a href="create_instructor.php" class="back-button">Create Another Instructor ID</a>
