...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $conn->prepare("SELECT user_id FROM lms_managers WHERE manager_id = ?");
    ...
    if ($user_id) {
        ...
        $stmt1 = $conn->prepare("DELETE FROM lms_managers WHERE manager_id = ?");
        ...
        $action = "Deleted LMS Manager & Reg. No. : $reg_no";
