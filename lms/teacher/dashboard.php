...
<body>
    ...
    <div class="content">
        <div class="header">
            <h2>Welcome, <span id="username"><?= htmlspecialchars($instructor['username']) ?></span>!</h2>
        </div>
        ...
        <div class="info-item"><span class="info-title">Reg. No. :</span> <span><?= htmlspecialchars($instructor_id) ?></span></div>
        ...
        <div class="info-item"><span class="info-title">Date of Birth:</span> <span><?= date('d-m-Y', strtotime($dob)) ?></span></div>
        <div class="info-item"><span class="info-title">Gender:</span> <span><?= htmlspecialchars($gender) ?></span></div>
        <div class="info-item"><span class="info-title">Faculty:</span> <span><?= htmlspecialchars($faculty_name) ?></span></div>
        <div class="info-item"><span class="info-title">Department:</span> <span><?= htmlspecialchars($department_name) ?></span></div>
        <div class="info-item"><span class="info-title">Rank:</span> <span><?= htmlspecialchars($rank) ?></span></div>
