...
<body>
    ...
    <script>
        ...
        function filterAttendance() {
            ...
            let url = "fetch_attendance.php";
            let params = [];

            // Add degree filter if selected
            if (degree) params.push(`degree_id=${degree}`);
            // Add semester filter if selected
            if (semester) params.push(`semester_id=${semester}`);
            // Add section filter if selected
            if (section) params.push(`section_id=${section}`);

            // Send a request with the selected filters
            fetch(url, {
                method: "POST",
